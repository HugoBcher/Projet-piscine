                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" style="margin-left: 20px;">
                            ...
                            <form method="post" action="poster.php">
                                <input type="text" name="chemin" id="name" placeholder="" style="width: 500px; background: #D5D8DC; color: black;"/><br><br>
                                
                                <input class="btn btn-outlined" style="background-color: black; color: white; margin-left: 50px;"type="submit" name="submit" value="Rechercher" /> 
                            </form>
                                </div>
