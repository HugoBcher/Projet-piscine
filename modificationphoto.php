                ...
                if($db_handle && $db_found){
                    ...
                    echo '<div class="mapage">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                <form method="post" action="modifierphoto.php" style="margin-right:0px; margin-left: 0px;">
                                    
                                    <input type="submit" value="Modifier" style="background-color: black; color: white; margin-top: 15px;  height: 30px; "/>
                                    <textarea style="height: 30px; width: 350px; margin-top: 5px; color: black;" name="chemin_profil" value="'.$db_field1['chemin_profil'].'">'.$db_field1['chemin_profil'].'</textarea>
                                </form> 
                                <form method="post" action="suppressionphoto" style="margin-right:0px; ">
