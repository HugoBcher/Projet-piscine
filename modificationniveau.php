            ...
            <div style="text-align: center; width: 100%;">
                <h2 >Vos informations</h2>
                    ...
                    <?php
                        ...
                        <br> <strong>Niveau d\'études</strong><br>Bac+
                        <form method="post" action="modifierniveau.php">
                            <textarea style="height: 30px; width: 150px; margin-top: 5px; color: black;" name="experience" value="'.$db_field1['Level'].'"> '.$db_field1['Level'].'</textarea> <br>
                            
                                <input type="submit" value="Modifier votre niveau" style="background-color: #3F90F2; color: white; margin-top:15px; height: 30px; "/>
                            </form>
                        <br><br> <strong>Bac obtenu </strong><br> '.$db_field1['Tag1'].'
