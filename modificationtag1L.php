            ...
            <div style="text-align: center; width: 100%;">
                <h2 >Vos informations</h2>
                    ...
                    <?php
                        ...
                        <br> <strong>Intérêts </strong><br> 
                        <br><form method="post" action="modifiertag1L.php">
                        <textarea style="height: 30px; width: 150px; margin-top: 5px; color: black;" name="interet" value="'.$db_field1['Tag1'].'">'.$db_field1['Tag1'].'</textarea> <br>
