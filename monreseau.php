...
<div id="preloader"></div>
        ...
        <section id="services" class="white">
            <div class="row">
                ...
                if($db_handle && $db_found){
                    ...
                    $SQL = "SELECT COUNT(*) AS nb FROM utilisateur WHERE id IN (SELECT id2 FROM reseau WHERE id1 = '".$id."')" ;
                    $result = mysqli_query($db_handle, $SQL);
                    $db_field=mysqli_fetch_assoc($result);
                    $nb = $db_field['nb'];
                    echo '<div style="margin-left: 20px;"> <h2> Vous avez '.$nb.' relation(s).</h2></div>';
                ...
                <div>
                    <br>
                    <p>
                        <button style="background-color: black;  margin-left: 40px;"><a href="chercher.php" style="color: white;"><img src="images/icones/recherche.png"> Agrandir mon réseau</a></button>
                    </p>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <form method="post" action="recherchedansami.php">
                        <input type="text" name="nom" placeholder="Tapez votre recherche">
                        <input style="background-color: black; color: white; margin-left: 10px;" type="submit" name="Rechercher" value="Rechercher">
    ...
    <?php
                if($db_handle && $db_found){
                    ...
                    $SQL2 = "SELECT * FROM utilisateur WHERE id IN (SELECT id2 FROM reseau WHERE id1 = '".$id."') ORDER BY nom ASC" ;
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="service-block">
                            <div class="pull-left bounce-in">
                                <img src="'.$db_field2['chemin_profil'].'" style="height: 60px; width: 60px; margin-right: 10px;">
                            </div>
                            <div class="media-body fade-up">
                                <h3 class="media-heading" style="margin-right: 2px;"> <a href="profil.php?id='.$idami.'">'.$db_field2['prenom'].' '.$db_field2['nom'].'</a>
                                
                                </h3>
                            
                                <form method="post" action="suppressionami.php" style="margin-right:0px;">
