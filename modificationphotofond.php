                ...
                if($db_handle && $db_found){
                    ...
                    echo '<div class="mapage">
                            <div class="row">
                                ...
                                <div class="col-sm-2" >
                                    <form method="post" action="modifierphotofond.php" style="margin-right:0px; margin-left: 0px;">
                                    <input type="submit" value="Modifier la photo de fond" style="background-color: black; color: white; margin-top: 15px;  height: 30px; "/>
                                    <textarea style="height: 30px; width: 180px; margin-top: 5px; color: black;" name="chemin_fond" value="'.$db_field1['chemin_fond'].'">'.$db_field1['chemin_fond'].'</textarea>
                                </form> 
