            ...
            <div class="col-sm-4 colgauche">
                ...
                <div style="text-align: left; margin-left: 50px;">
                    <?php
                        ...
                        <br><br> <strong>Intérêts :</strong><br> 
                        <br><form method="post" action="modifierinterets.php">
                            <textarea style="height: 30px; width: 350px; margin-top: 5px; color: black;" name="interets" value="'.$db_field1['interets'].'">'.$db_field1['interets'].'</textarea>
                            
                                <input type="submit" value="Modifier vos intérêts" style="background-color: black; color: white; margin-top:15px; height: 30px; "/>
                            </form>';
