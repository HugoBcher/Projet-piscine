        ...
        <section id="services" class="white">
            <div class="row">
                ...
                $pseudo = $_POST['pseudo'];
                    ...
                    $SQL = "SELECT * FROM utilisateur WHERE (prenom='".$prenom."' OR nom='".$nom."' OR pseudo='".$pseudo."') AND id NOT IN (SELECT id2 FROM reseau WHERE id1='".$id."')" ;
                    $result = mysqli_query($db_handle, $SQL);
                    
                    $SQL2 = "SELECT COUNT(*) AS nb FROM utilisateur WHERE (prenom='".$prenom."' OR nom='".$nom."' OR pseudo='".$pseudo."') AND id NOT IN (SELECT id2 FROM reseau WHERE id1='".$id."')" ;
                    $result2 = mysqli_query($db_handle, $SQL2);
                    $db_field2=mysqli_fetch_assoc($result2);
                    $nb = $db_field2['nb'];
                  
                        echo '<div style="margin-left: 20px;"> <h4> Il y a '.$nb.' résultat(s).</h4></div>';
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="service-block">
                            ...
                            <div class="media-body fade-up">
                                ...
                                <form method="post" action="demandeami.php" style="margin-right:0px;">
