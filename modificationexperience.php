                ...
                <div style="text-align: left; margin-left: 50px;">
                    <?php
                        ...
                        <br> <strong>Expérience :</strong><br> 
                         <form method="post" action="modifierexperience.php">
                            <textarea style="height: 30px; width: 350px; margin-top: 5px; color: black;" name="experience" value="'.$db_field1['experience'].'">'.$db_field1['experience'].'</textarea>
                            
                                <input type="submit" value="Modifier vos expériences" style="background-color: black; color: white; margin-top:15px; height: 30px; "/>
                            </form>
