                ...
                <h2 >Vos informations</h2>
                    ...
                    <?php
                        ...
                        <br><form method="post" action="modificationtag1.php">
                            ...
                            <br> <strong>Filière</strong><br> 
                        <br><form method="post" action="modifiertag2.php">
                        
                        
                        <textarea style="height: 30px; width: 150px; margin-top: 5px; color: black;" name="tag2" value="'.$db_field1['Tag2'].'"> '.$db_field1['Tag2'].'</textarea> <br>
