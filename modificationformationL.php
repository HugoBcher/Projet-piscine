                ...
                <h2 >Vos informations</h2>
                    ...
                    <?php
                        ...
                        echo '<strong><br><br>Formation</strong><br> 
                            <form method="post" action="modifierformationL.php">
                            <textarea style="height: 30px; width: 150px; margin-top: 5px; color: black;" name="formation" value="'.$db_field1['Sector'].'">'.$db_field1['Sector'].'</textarea> <br>
